...
public class TrackResource {
    ...
    public Response getTracks(@QueryParam("token") String token, @PathParam("playlistId") String playlistID) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response addTrackToPlaylist(@QueryParam("token") String token, @PathParam("playlistId") String playlistID, TrackRequestDTO track) {
        userService.verifyToken(token);
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Path("/{id}")
    public Response removeTrackFromPlaylist(@QueryParam("token") String token, @PathParam("playlistId") String playlistID, @PathParam("id") String trackId) {
        userService.verifyToken(token);
